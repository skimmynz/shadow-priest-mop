...
function updateSpellTable(effectiveHaste, isGoblin) {
  ...
  spellsHTML +=
    '<div class="breakpoint-explainer">' +
      '<p>In Mists of Pandaria Classic, a <strong>Haste Breakpoint</strong> is a specific amount of Haste rating at which a damage-over-time spell gains an additional tick before it expires.</p>' +
      '<p>DoTs like <a href="https://www.wowhead.com/mop-classic/spell=589/shadow-word-pain" data-wowhead="spell=589&domain=mop-classic"><img src="https://wow.zamimg.com/images/wow/icons/tiny/spell_shadow_shadowwordpain.gif" class="explainer-icon" alt="">Shadow Word: Pain</a>, <a href="https://www.wowhead.com/mop-classic/spell=34914/vampiric-touch" data-wowhead="spell=34914&domain=mop-classic"><img src="https://wow.zamimg.com/images/wow/icons/tiny/spell_holy_stoicism.gif" class="explainer-icon" alt="">Vampiric Touch</a>, and <a href="https://www.wowhead.com/mop-classic/spell=2944/devouring-plague" data-wowhead="spell=2944&domain=mop-classic"><img src="https://wow.zamimg.com/images/wow/icons/tiny/spell_shadow_devouringplague.gif" class="explainer-icon" alt="">Devouring Plague</a> tick at fixed intervals, but Haste shortens those intervals. Once you accumulate enough Haste to hit a breakpoint, that extra tick represents a significant DPS increase.</p>' +
    '</div>';
