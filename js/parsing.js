...
var PARSING_RULES = {
  ...
  1407: { title: "Will of the Emperor", noAsp: 'damage', rules: ["Damage done to Emperor's Rage is removed from 25-man Heroic.","Will of the Emperor is removed from Damage All Star Points."] },
  ...
  1463: { title: "Garalon", noAsp: 'damage', rules: ["Garalon is removed from Damage All Star Points."] },
  1498: { title: "Wind Lord Mel'jarak", rules: ["Damage done to adds that don't die is removed."] },
  1499: { title: "Amber-Shaper Un'sok", noAsp: 'all', rules: ["Amber-Shaper is removed from All Star Points (both Damage and Healing)."] },
  ...
  1431: { title: "Sha of Fear", noAsp: 'damage', rules: ["Sha of Fear is removed from Damage ASP."] },
  51577: { title: "Jin'rokh the Breaker", rules: ["No rules."] },
  51575: { title: "Horridon", noAsp: 'damage', rules: ["Horridon is removed from Damage All Star Points."] },
  ...
  51573: { title: "Ji-Kun", noAsp: 'damage', rules: ["Ji-Kun is removed from Damage All Star Points."] },
  51572: { title: "Durumu the Forgotten", rules: ["Damage done to Wandering Eye is removed."] },
  51574: { title: "Primordius", noAsp: 'all', rules: ["Primordius is removed from Damage and Healing All Star Points."] },
...
function getNoAsp(encounterId) {
  ...
  return (entry && entry.noAsp) ? entry.noAsp : null;
}
