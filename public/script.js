...
    // MODIFIED: This section is now collapsed by default.
    const collapsibleTalentSummary = `
      <div class="talent-summary-container">
        <button type="button" class="collapsible-header" id="talent-summary-toggle" aria-expanded="false">
          <h3>Talent Usage Summary</h3>
          <span class="expand-icon">▼</span>
        </button>
        <div id="talent-summary-content" class="collapsible-content">
          ${talentSummaryHTML}
        </div>
      </div>
    `;
